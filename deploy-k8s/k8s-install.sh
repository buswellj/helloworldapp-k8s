...
ssh -x -l $INV_TGT_USER $INV_TGT_HOST "sudo apt-get update -y && apt-get upgrade -y"
echo " [-] Installing git, screen and net-tools"
ssh -x -l $INV_TGT_USER $INV_TGT_HOST "sudo apt-get install git -y && apt-get install screen -y && apt-get install net-tools -y"
echo " [-] Installing Lynx, Unzip, GPG and jq"
ssh -x -l $INV_TGT_USER $INV_TGT_HOST "sudo apt-get install lynx -y && apt-get install unzip -y && apt-get install gpg -y && apt-get install jq -y"
